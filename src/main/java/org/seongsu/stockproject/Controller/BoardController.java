...
public class BoardController {
	...
	public ResponseEntity<noticeboardVO> createNotice(@RequestBody noticeboardVO vo) {
		boardService.createNotice(vo);
		return ResponseEntity.status(HttpStatus.OK).build();
	}

	@PutMapping("/notice/update")
	public ResponseEntity<noticeboardVO> updateNotice(@RequestBody noticeboardVO vo) {
